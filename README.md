...
Tests/
  LogHorizon.Tests.ps1       416 Pester v5 unit tests
Tools/
...
416 Pester v5 tests, no Azure connectivity required. Run them from a plain PowerShell session rather than the VS Code integrated terminal:
